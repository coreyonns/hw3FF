    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method ="post" action="">
          ...
          <div class="mb-3">
            <label for="tDiv<?php echo $team['team_id']; ?>" class="form-label">Team Division</label>
            <input type="text" class="form-control" id="tDiv<?php echo $team['team_id']; ?>" name="tDiv" value="<?php echo $team['team_division']; ?>">
          </div>
